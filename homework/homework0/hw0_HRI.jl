...
student = (name = "Hermes Rozsa", kerberos_id = "herozigle@gmail.com")
...
ex_1_1="To ensure convergence to the root of the number"
...
# ╔═╡ e1916202-efb2-11ea-2cde-e1a49711bc67
function newton_sqrt!(l::Newton)
 while abs(l.x-l.a^2) > l.e
         l.a = (l.a + l.x/l.a)/2
         println(l.a)
   end  
	l.a
...
Root = Newton((x=2,  a =1, e = 0.00000005)...)


# ╔═╡ 4824a640-efb2-11ea-0d97-fd7d800acf41
newton_sqrt!(Root)	

# ╔═╡ cf52c000-efb4-11ea-171d-c993fa909405
sqrt(2)
